<div x-data="{ isOpen: false, openedWithKeyboard: false }"
    ...
    <button type="button" aria-label="context menu" @click="isOpen = ! isOpen" @contextmenu.prevent="isOpen = true"
            ...
            class="z-10 inline-flex items-center justify-center transition rounded-md cursor-pointer w-7 h-7 hover:opacity-75 focus-visible:outline
             focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-800 active:opacity-100 dark:focus-visible:outline-slate-300"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 mt-1.5">
